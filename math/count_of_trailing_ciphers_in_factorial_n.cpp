...
void tests() {
    ...
    if(count_of_number_of_ciphers_in_factorial_n(395) == (int)97) std::cout << "passed\n";
    else std::cout << "failed\n";

    std::cout << "Test 2:\t n=977\n";
    if(count_of_number_of_ciphers_in_factorial_n(977) == (int)242) std::cout << "passed\n";
    else std::cout << "failed\n";

    std::cout << "Test 3:\t n=871\n";
    if(count_of_number_of_ciphers_in_factorial_n(871) == (int)215) std::cout << "passed\n";
    else std::cout << "failed\n";

    std::cout << "Test 4:\t n=239\n";
    if(count_of_number_of_ciphers_in_factorial_n(239) == (int)57) std::cout << "passed\n";
    else std::cout << "failed\n";
}
