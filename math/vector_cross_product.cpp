...
// Declares the cross() function for finding the cross product of the given two vectors.
std::array<double, 3> cross(std::array<double, 3> A, std::array<double, 3> B) {
	// Declares an array for containing the direction ratios of the product vector.
