...
high. ai = bi (for i <= k) ai = c1*ai-1 + c2*ai-2 + ... + ck*ai-k (for i > k)
...
4. Multiply with F to get the last matrix of size (1xk). The first element of
this matrix is the required result.
*/
