 ...
 * @returns the point directly below the top of the stack
 *******************************************************************************/
 ...
 * @returns -1 if vp1 comes before vp2 in the sorted order, 1 otherwise
 *******************************************************************************/
...
/******************************************************************************
 * @brief Finds the convex hull of a set of n points.
 * @param points vector of Point<int, int> with co-ordinates.
 * @param size Size of the vector.
 * @returns the points of the convex hull, or an empty vector if there are
