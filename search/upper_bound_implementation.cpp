/******************************************************************************
 * @file
 * @brief [Upper Bound Binary search algorithm](https://en.wikipedia.org/wiki/Binary_search_algorithm)
 * @details
...
uint64_t binarySearch(std::vector<uint64_t> arr, uint64_t val) {
    ...
    while (low < high) {
        ...
        if (val >= arr[mid]) {
            /****************************************************
             * if pivot point is greater than or equal to the val, then find in the
             * right subarray
             ****************************************************/
            low = mid + 1;
        }
            /****************************************************
            * if pivot point is lesser than val, then find in the left subarray
            ****************************************************/
        else {
            high = mid;
        }
