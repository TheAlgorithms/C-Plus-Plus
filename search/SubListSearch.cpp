/* C++ program to find a list in second list . The first list is the list to be searched
and the second list is the list in which search will be performed.
...
{ 
	...
	SubListSearch(a,b) ? cout << "LIST FOUND" : 
					cout << "LIST NOT FOUND"; 
