 ...
 * 
 * @brief Implementation to [Next higher number with same number of set bits](https://www.geeksforgeeks.org/next-higher-number-with-same-number-of-set-bits/)
 * @details
 ...
 */
        std::uint64_t samenumberofbits(uint64_t n)
        {
            ...
            if(n)
            {
                right=n &-(signed)n;  //right most set bit
