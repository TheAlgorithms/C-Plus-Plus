...
ComplVec FastFourierTransform(ComplVec &p) {
    ...
    auto pe = ComplVec(n / 2);  /// Coefficients of even power
    auto po = ComplVec(n / 2);  /// Coefficients of odd power
    ...
    ComplVec ye = FastFourierTransform(pe);  /// Recursive Call

    ComplVec yo = FastFourierTransform(po);  /// Recursive Call

    ComplVec y = ComplVec(n);  /// Final value representation list
...
//    auto *t2 = new std::complex<double>[4];  /// Test case 2
    ...
    numerical_methods::ComplVec o1 = numerical_methods::FastFourierTransform(t1);
    numerical_methods::ComplVec o2 = numerical_methods::FastFourierTransform(t2);
